...
$config['1st_meet_begin'] = '9:00'; /** first meeting begining hour as a string (hours) */
$config['last_meet_end'] = '16:15'; /** last meeting ending hour as a string (hours) */
$config['meet_duration'] = '45 minutes'; /** duration of each meeting as a string (hours) */
$config['worked_days'] = array('Monday' => 'lundi', 'Tuesday' => 'mardi', 'Wednesday' => 'mercredi', 'Thursday' => 'jeudi', 'Friday' => 'vendredi'); /** worked week days as an associative array (keys : weekdays in english with a capital, values : translation to display) */
